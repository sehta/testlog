    ...
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider',
        ...
        function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
            ...
            $stateProvider
                ...
                .state('app.hrdashboard', {
                    url: "/hrdashboard",
                    templateUrl: "tpl/hrdashboard.html",
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load([
                                        'assets/js/controllers/hrdashboard.js'
                                    ]);
                                });
                        }]
                    }
                 ...
                 .state('app.admindashboard', {
                     url: "/adminDashboard",
                     templateUrl: "templates/company_admin.html",
            ...
            .state('app.forms', {
             ...
             .state('app.settings', { 
                    ...
                    templateUrl: 'templates/forms_settings.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([                                    
                                ...
                                .then(function() { 
                                    return $ocLazyLoad.load('assets/js/controllers/user.js');
                                });
                        }]
                    }
                }) 
